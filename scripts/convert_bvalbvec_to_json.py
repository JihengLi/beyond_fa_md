...
bval_file = "/nfs2/harmonization/BIDS/MASiVar/derivatives/sub-cIVs044/ses-s1Bx1/PreQual/PREPROCESSED/dwmri.bval"
bvec_file = "/nfs2/harmonization/BIDS/MASiVar/derivatives/sub-cIVs044/ses-s1Bx1/PreQual/PREPROCESSED/dwmri.bvec"
output = "/home-local/lij112/codes/beyond_fa_challenge/dataset/sub-cIVs044_ses-s1Bx1_pq_dwmri.json"
    ...
    for i in range(len(bvals)):
        entry = {
            ...
            "BVEC": [
                ...
                bvecs[1][i],
                bvecs[2][i],
            ],  # Use each gradient's orientation from bvec
        }
        data.append(entry)
...
bval_bvec_to_json(bval_file, bvec_file, output)
